...
{
	{0x02, LEVEL_1, NULL			        		, Get_AirBrand_Attr        		,0},
	{0x03, LEVEL_1, Set_AirStatus_Attr      		, Get_AirStatus_Attr     		,0},
	{0x04, LEVEL_1, Set_AirStatus_Attr      		, Get_AirStatus_Attr       		,0},
	{0x05, LEVEL_1, Set_AirStatus_Attr      		, Get_AirStatus_Attr			,0},
	{0x06, LEVEL_1, Set_AirStatus_Attr      		, Get_AirStatus_Attr   			,0},
	{0x07, LEVEL_1, Set_AirStatus_Attr     			, Get_AirStatus_Attr			,0},
	{0x09, LEVEL_0, Set_AirStatus_Attr     			, NULL       					,0},
	{0x0a, LEVEL_0, Set_AirStatus_Attr     			, NULL       					,0},
	{0x0b, LEVEL_0, Set_AirStatus_Attr				, NULL       					,0},
	{0x0c, LEVEL_0, Set_AirStatus_Attr				, NULL       					,0},
	{0x0d, LEVEL_0, Set_AirStatus_Attr     			, NULL       					,0},
	{0x0e, LEVEL_0, Set_AirStatus_Attr     			, NULL       					,0},
	{0x0F, LEVEL_0, NULL			     			, Get_AirStatus_Attr			,0},
	{0x10, LEVEL_0, Set_AirTimer_Attr     			, Get_AirStatus_Attr			,0},
	
	{0x11, LEVEL_0, Set_BindObject_Attr     		, Get_BindObject_Attr			,0}, //Add zyh 20150429
	{0x12, LEVEL_0, Set_SelfAdjust_Attr     	  	, Get_SelfAdjust_Attr		    ,0}, //Add zyh 20150429
	{0x13, LEVEL_0, Set_MaxMinTemperature_Attr  	, Get_MaxMinTemperature_Attr	,0}, //Add zyh 20150429

	{0x14, LEVEL_0, Set_Correction_Temperature_Attr	,Get_Correction_Temperature_Attr,0}, //Add 20150907
	{0x15, LEVEL_0, Set_Air_Type_Attr  				, Get_Air_Type_Attr				,0}, //Add 20150907
	{0x16, LEVEL_0, Set_Air_Addr_Attr  				, Get_Air_Addr_Attr				,0}, //Add 20150907
	{0x17, LEVEL_0, Set_Air_List_Addr_Attr			, Get_Air_List_Addr_Attr		,0}, //Add 20150907
	
	{0x50, LEVEL_1, Set_AirStatus_Attr     	    	, Get_AirStatus_Attr      		,0},
	{0x80, LEVEL_0, Set_DeviceRelate_Attr       	, Get_DeviceRelate_Attr      	,0},   //读写设备关联属性
	{0x81, LEVEL_0, Set_DeviceRelateSwitch_Attr 	, Get_DeviceRelateSwitch_Attr	,0},   //使能/禁能 数据发送
	{0x82, LEVEL_0, Set_RS232Cfg_Attr 				, Get_RS232Cfg_Attr				,0},   //Add zyh 20150429
};
...
/*****************************************************************************
函 数 名:  	u8 Air_UnitAttrNum(void)
功能说明:  	计算空调属性命令的个数
参    数:  	无
返 回 值:  	空调属性的个数
*****************************************************************************/
u8 Air_UnitAttrNum(void)
{
	return (BF_DIM(AirAttrTab));
}
...
MsgResult_t Set_Air_Type_Attr(UnitPara_t *pData)
{
	if(pData->data[0] > 2)
	{
		gAirConfigPara.Air_type = 2;
		EEPROM_Write(RS485_PARA_ADDR, sizeof(Air_Para_t), (u8*)&gAirConfigPara);
		return PARA_MEANING_ERR;
	}
	else
	{
